...
,
...

  {
    ...
    choices: ["Apply the relevant definition and check domain/units.", "Use a common shortcut that ignores a required domain restriction.", "Apply a related formula even though its assumptions are not fully met.", "Carry out correct algebra but fail to interpret the transformed sign/inequality context."],
    answerIndex: 0,
...

  {
    ...
    choices: ["It reduces confounding effects and random error.", "It increases precision but does not directly control key confounders.", "It strengthens internal validity, but only for a narrow, non-representative sample.", "It improves data quality, yet still requires careful inferential analysis."],
    answerIndex: 0,
...

  {
    ...
    choices: ["Compare methods, sample quality, and reproducibility before concluding.", "Prioritize whichever study has the larger sample size, even if design quality is weaker.", "Prefer the study with stronger statistical significance without checking external validity.", "Average both conclusions immediately without resolving differences in measurement or design."],
    answerIndex: 0,
...

  {
    ...
    choices: ["It relies on evidence from observations and experiments.", "It relies mostly on evidence but treats a single study as conclusive across all contexts.", "It uses models effectively but assumes model outputs are always exact representations of reality.", "It focuses on causal claims but underweights uncertainty and competing explanations."],
    answerIndex: 0,
...

  {
    ...
    choices: ["Primary-source documents from the period", "Later secondary syntheses with strong citations but limited direct source excerpts", "A single first-person memoir without independent corroboration", "A tertiary timeline summary with minimal source apparatus"],
    answerIndex: 0,
...

  {
    ...
    choices: ["The one that uses multiple corroborated primary sources and addresses counterevidence", "The one with broad coverage but limited source-criticism of key documents", "The one with a coherent narrative but narrow citation diversity across archives", "The one that aligns with dominant historiography but omits disconfirming records"],
    answerIndex: 0,
...
,
...

  {
    ...
    choices: ["Substitute/check against original constraints and interpretation.", "Substitute into a transformed equation but skip checking restrictions in the original form.", "Verify algebra at one convenient test value and generalize without full validation.", "Keep symbolic work exact but overlook context/unit interpretation in the final step."],
    answerIndex: 0,
...
,
  ...
  // --- SESSION LENGTH SUPPORT PACK ---
  {
    ...
    choices: ["Claims must be testable and evidence-based.", "Mechanistic plausibility can outweigh mixed empirical findings when the narrative is coherent.", "A very large observed effect can justify relying on one well-run study without replication.", "If a model fits historical data closely, further falsification tests are usually low priority."],
    answerIndex: 0,
...

  {
    ...
    choices: ["Re-examine method and weight replicated evidence more heavily.", "Keep the original claim because early novel findings are often later confirmed.", "Treat both results as equally strong until a formal meta-analysis is published.", "Prefer the result with the stronger p-value even if protocol quality differs."],
    answerIndex: 0,
...

  {
    ...
    choices: ["Controlled variables with repeated trials", "High-frequency observational data without explicit control of confounders", "Post-hoc subgroup matching after reviewing outcomes", "One large cross-sectional snapshot with no intervention or randomization"],
    answerIndex: 0,
...

  {
    ...
    choices: ["Clear assumptions plus evidence", "Plausible assumptions with weak identification of key variables", "A model with internal consistency but little empirical validation", "Strong evidence on one margin while leaving major trade-offs untested"],
    answerIndex: 0,
...
,
  ...
  // --- CONSTRUCTED RESPONSE MATH PRACTICE ---
  {
    id: "frq-alg1-linear-eq-01",
    subject: "Algebra 1",
    topic: "Linear Equations",
    subtopic: "Linear Equations",
    difficulty: "medium",
    rigor: 2,
    question: "Solve for $x$: $7x-5=30$.",
    choices: [],
    answerIndex: 0,
    responseType: "input",
    numericAnswer: 5,
...

  {
    ...
    difficulty: "medium",
    rigor: 2,
    question: "What is the greatest integer $x$ satisfying $3x+2\\le 11$?",
    choices: [],
    answerIndex: 0,
    responseType: "input",
    numericAnswer: 3,
    tolerance: 0,
    explanation: "$3x\\le9\\Rightarrow x\\le3$, so greatest integer is 3.",
  },

  {
    ...
    difficulty: "hard",
    rigor: 3,
    question: "For $x+y=11$ and $x-y=1$, type the value of $x$.",
    choices: [],
    answerIndex: 0,
    responseType: "input",
    numericAnswer: 6,
...

  {
    ...
    difficulty: "medium",
    rigor: 2,
    question: "If $f(x)=2x^2-3x+1$, type $f(4)$.",
    choices: [],
    answerIndex: 0,
    responseType: "input",
    numericAnswer: 21,
...

  {
    ...
    difficulty: "medium",
    rigor: 2,
    question: "For $x^2-9x+20=0$, type the sum of the roots.",
    choices: [],
    answerIndex: 0,
    responseType: "input",
    numericAnswer: 9,
    tolerance: 0,
    explanation: "By Vieta, sum is $-\\frac{b}{a}=9$.",
  },

  {
    id: "frq-alg2-complex-01",
    subject: "Algebra 2",
    topic: "Complex Numbers",
    subtopic: "Complex Numbers",
    difficulty: "medium",
    rigor: 2,
    question: "For $(2+3i)(1-4i)$, type the real part.",
    choices: [],
    answerIndex: 0,
    responseType: "input",
    numericAnswer: 14,
    tolerance: 0,
    explanation: "Expand: $2-8i+3i-12i^2=14-5i$, real part is 14.",
  },

  {
    ...
    difficulty: "easy",
    rigor: 1,
    question: "Solve $\\log_{10}(x)=3$. Type $x$.",
    choices: [],
    answerIndex: 0,
    responseType: "input",
    numericAnswer: 1000,
...

  {
    ...
    difficulty: "hard",
    rigor: 3,
    question: "Evaluate $\\frac{x^2-4}{x-2}$ at $x=5$. Type the value.",
    choices: [],
    answerIndex: 0,
    responseType: "input",
    numericAnswer: 7,
    tolerance: 0,
    explanation: "Simplifies to $x+2$ for $x\\ne2$, so value is 7.",
  },

  {
    ...
    difficulty: "medium",
    rigor: 2,
    question: "In a right triangle with opposite side 6 and hypotenuse 10, type $\\sin\\theta$ as a decimal.",
    choices: [],
    answerIndex: 0,
    responseType: "input",
    numericAnswer: 0.6,
    tolerance: 0.01,
    explanation: "$\\sin\\theta=\\frac{6}{10}=0.6$.",
  },

  {
    ...
    difficulty: "medium",
    rigor: 2,
    question: "Type the slope between $(2,-1)$ and $(8,11)$.",
    choices: [],
    answerIndex: 0,
    responseType: "input",
    numericAnswer: 2,
    tolerance: 0,
    explanation: "$m=\\frac{11-(-1)}{8-2}=\\frac{12}{6}=2$.",
  },

  {
    ...
    difficulty: "medium",
    rigor: 2,
    question: "Type the volume of a cylinder with $r=3$ and $h=4$ in terms of the coefficient of $\\pi$ only.",
    choices: [],
    answerIndex: 0,
    responseType: "input",
    numericAnswer: 36,
    tolerance: 0,
    explanation: "$V=\\pi r^2h=\\pi(9)(4)=36\\pi$.",
  },

  {
    ...
    difficulty: "hard",
    rigor: 3,
    question: "Similar triangles have side ratio $2:5$. If smaller area is 18, type larger area.",
    choices: [],
    answerIndex: 0,
    responseType: "input",
    numericAnswer: 112.5,
    tolerance: 0.01,
    explanation: "Area scales by ratio squared: $18\\cdot(\\frac{5}{2})^2=112.5$.",
  },

  {
    ...
    difficulty: "medium",
    rigor: 2,
    question: "Evaluate $\\lim_{x\\to3}\\frac{x^2-9}{x-3}$. Type the value.",
    choices: [],
    answerIndex: 0,
    responseType: "input",
    numericAnswer: 6,
    tolerance: 0,
    explanation: "Factor and cancel: limit becomes $x+3$ at $x=3$.",
  },

  {
    ...
    difficulty: "medium",
    rigor: 2,
    question: "If $f(x)=x^3-4x$, type $f'(2)$.",
    choices: [],
    answerIndex: 0,
    responseType: "input",
    numericAnswer: 8,
    tolerance: 0,
    explanation: "$f'(x)=3x^2-4$, so $f'(2)=12-4=8$.",
  },

  {
    ...
    difficulty: "medium",
    rigor: 2,
    question: "Compute $\\int_0^2 3x^2\\,dx$. Type the value.",
    choices: [],
    answerIndex: 0,
    responseType: "input",
    numericAnswer: 8,
    tolerance: 0,
    explanation: "Antiderivative is $x^3$, so value is $8-0=8$.",
  },

  {
    ...
    difficulty: "hard",
    rigor: 3,
    question: "If $s(t)=t^3-6t^2+9t$, type instantaneous velocity at $t=2$.",
    choices: [],
    answerIndex: 0,
    responseType: "input",
    numericAnswer: -3,
    tolerance: 0,
    explanation: "$v(t)=s'(t)=3t^2-12t+9$, so $v(2)=12-24+9=-3$.",
  },

  {
    ...
    difficulty: "hard",
    rigor: 3,
    question: "For $f(x)=x^2$ on $[1,5]$, MVT gives $f'(c)=6$. Type $c$.",
    choices: [],
    answerIndex: 0,
    responseType: "input",
    numericAnswer: 3,
    tolerance: 0,
    explanation: "$f'(x)=2x$, so $2c=6\\Rightarrow c=3$.",
  },

  {
    ...
    difficulty: "hard",
    rigor: 3,
    question: "If $F(x)=\\int_1^x (2t+1)dt$, type $F'(4)$.",
    choices: [],
    answerIndex: 0,
    responseType: "input",
    numericAnswer: 9,
    tolerance: 0,
    explanation: "FTC Part I: $F'(x)=2x+1$, so $F'(4)=9$.",
  },

  {
    ...
    difficulty: "hard",
    rigor: 3,
    question: "Type the area between $y=x$ and $y=x^2$ on $[0,1]$ as a decimal.",
    choices: [],
    answerIndex: 0,
    responseType: "input",
    numericAnswer: 0.1667,
    tolerance: 0.01,
    explanation: "$\\int_0^1(x-x^2)dx=\\frac{1}{6}\\approx0.1667$.",
  },

  {
    ...
    difficulty: "hard",
    rigor: 3,
    question: "Rotate $y=x$ on $[0,2]$ about the $x$-axis. Type the volume divided by $\\pi$.",
    choices: [],
    answerIndex: 0,
    responseType: "input",
    numericAnswer: 2.6667,
    tolerance: 0.01,
    explanation: "$V=\\pi\\int_0^2x^2dx=\\frac{8\\pi}{3}$, so coefficient is $\\frac{8}{3}\\approx2.6667$.",
  },

  {
    id: "frq-apbc-param-01",
    subject: "AP Calculus BC",
    topic: "Parametric & Polar",
    subtopic: "Parametric & Polar",
    difficulty: "hard",
    rigor: 3,
    question: "If $x=t^2+1$, $y=t^3-t$, type $\\frac{dy}{dx}$ at $t=2$.",
    choices: [],
    answerIndex: 0,
    responseType: "input",
    numericAnswer: 2.75,
    tolerance: 0.01,
    explanation: "$\\frac{dy}{dx}=\\frac{3t^2-1}{2t}$ gives $\\frac{11}{4}=2.75$.",
  },

  {
    id: "frq-apbc-series-01",
    subject: "AP Calculus BC",
    topic: "Infinite Series",
    subtopic: "Infinite Series",
    difficulty: "hard",
    rigor: 3,
    question: "Type the sum of $\\sum_{n=0}^{\\infty}(\\frac{1}{3})^n$.",
    choices: [],
    answerIndex: 0,
    responseType: "input",
    numericAnswer: 1.5,
    tolerance: 0.01,
    explanation: "Geometric series sum is $\\frac{1}{1-r}=\\frac{3}{2}$.",
  },

  {
    id: "frq-apbc-parts-01",
    subject: "AP Calculus BC",
    topic: "Integration by Parts",
    subtopic: "Integration by Parts",
    difficulty: "hard",
    rigor: 3,
    question: "For $\\int xe^x\\,dx=xe^x-e^x+C$, type the coefficient of the standalone $e^x$ term.",
    choices: [],
    answerIndex: 0,
    responseType: "input",
    numericAnswer: -1,
    tolerance: 0,
    explanation: "The standalone term is $-e^x$, so coefficient is -1.",
  },

  {
    id: "frq-apbc-logistic-01",
    subject: "AP Calculus BC",
    topic: "Logistic Growth",
    subtopic: "Logistic Growth",
    difficulty: "medium",
    rigor: 2,
    question: "In logistic model $P(t)=\\frac{K}{1+Ae^{-rt}}$, type $\\lim_{t\\to\\infty}P(t)$ if $K=500$.",
    choices: [],
    answerIndex: 0,
    responseType: "input",
    numericAnswer: 500,
    tolerance: 0,
    explanation: "Limit is carrying capacity $K$, so 500.",
  },

  {
    id: "frq-apstat-prob-01",
    subject: "AP Statistics",
    topic: "Probability Distributions",
    subtopic: "Probability Distributions",
    difficulty: "medium",
    rigor: 2,
    question: "Type $E[X]$ if $P(X=1)=0.2$, $P(X=2)=0.3$, $P(X=3)=0.5$.",
    choices: [],
    answerIndex: 0,
    responseType: "input",
    numericAnswer: 2.3,
    tolerance: 0.01,
    explanation: "$E[X]=1(0.2)+2(0.3)+3(0.5)=2.3$.",
  },

  {
    id: "frq-apstat-inf-01",
    subject: "AP Statistics",
    topic: "Inference",
    subtopic: "Inference",
    difficulty: "hard",
    rigor: 3,
    question: "Type the 95% CI margin of error if $z^*=1.96$, $\\sigma=10$, and $n=100$.",
    choices: [],
    answerIndex: 0,
    responseType: "input",
    numericAnswer: 1.96,
    tolerance: 0.01,
    explanation: "MOE $=z^*\\sigma/\\sqrt{n}=1.96\\cdot10/10=1.96$.",
  },

  {
    id: "frq-apstat-chi-01",
    subject: "AP Statistics",
    topic: "Chi-Square Tests",
    subtopic: "Chi-Square Tests",
    difficulty: "medium",
    rigor: 2,
    question: "Type the chi-square contribution for one cell with observed 30 and expected 24.",
    choices: [],
    answerIndex: 0,
    responseType: "input",
    numericAnswer: 1.5,
    tolerance: 0.01,
    explanation: "Contribution is $\\frac{(30-24)^2}{24}=\\frac{36}{24}=1.5$.",
  },

  {
    id: "frq-apstat-reg-01",
    subject: "AP Statistics",
    topic: "Linear Regression",
    subtopic: "Linear Regression",
    difficulty: "medium",
    rigor: 2,
    question: "For model $\\hat y=4+2.5x$, type $\\hat y$ when $x=6$.",
    choices: [],
    answerIndex: 0,
    responseType: "input",
    numericAnswer: 19,
    tolerance: 0,
    explanation: "$\\hat y=4+2.5(6)=19$.",
  }
